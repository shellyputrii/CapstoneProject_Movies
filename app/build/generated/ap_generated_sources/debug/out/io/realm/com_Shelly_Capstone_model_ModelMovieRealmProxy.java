...
public class com_Shelly_Capstone_model_ModelMovieRealmProxy extends com.Shelly.Capstone.model.ModelMovie
    implements RealmObjectProxy, com_Shelly_Capstone_model_ModelMovieRealmProxyInterface {
    ...
    private ProxyState<com.Shelly.Capstone.model.ModelMovie> proxyState;

    com_Shelly_Capstone_model_ModelMovieRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.Shelly.Capstone.model.ModelMovie>(this);
    ...
    @SuppressWarnings("cast")
    public static com.Shelly.Capstone.model.ModelMovie createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.Shelly.Capstone.model.ModelMovie obj = realm.createObjectInternal(com.Shelly.Capstone.model.ModelMovie.class, true, excludeFields);

        final com_Shelly_Capstone_model_ModelMovieRealmProxyInterface objProxy = (com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.Shelly.Capstone.model.ModelMovie createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.Shelly.Capstone.model.ModelMovie obj = new com.Shelly.Capstone.model.ModelMovie();
        final com_Shelly_Capstone_model_ModelMovieRealmProxyInterface objProxy = (com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.Shelly.Capstone.model.ModelMovie copyOrUpdate(Realm realm, com.Shelly.Capstone.model.ModelMovie object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.Shelly.Capstone.model.ModelMovie) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.Shelly.Capstone.model.ModelMovie copy(Realm realm, com.Shelly.Capstone.model.ModelMovie newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.Shelly.Capstone.model.ModelMovie realmObject = realm.createObjectInternal(com.Shelly.Capstone.model.ModelMovie.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_Shelly_Capstone_model_ModelMovieRealmProxyInterface realmObjectSource = (com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) newObject;
        com_Shelly_Capstone_model_ModelMovieRealmProxyInterface realmObjectCopy = (com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.Shelly.Capstone.model.ModelMovie object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.Shelly.Capstone.model.ModelMovie.class);
        long tableNativePtr = table.getNativePtr();
        ModelMovieColumnInfo columnInfo = (ModelMovieColumnInfo) realm.getSchema().getColumnInfo(com.Shelly.Capstone.model.ModelMovie.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Title = ((com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) object).realmGet$Title();
        if (realmGet$Title != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.TitleIndex, rowIndex, realmGet$Title, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelMovieColumnInfo columnInfo = (ModelMovieColumnInfo) realm.getSchema().getColumnInfo(com.Shelly.Capstone.model.ModelMovie.class);
        com.Shelly.Capstone.model.ModelMovie object = null;
        while (objects.hasNext()) {
            object = (com.Shelly.Capstone.model.ModelMovie) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.Shelly.Capstone.model.ModelMovie object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.Shelly.Capstone.model.ModelMovie.class);
    ...
    public static com.Shelly.Capstone.model.ModelMovie createDetachedCopy(com.Shelly.Capstone.model.ModelMovie realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.Shelly.Capstone.model.ModelMovie unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.Shelly.Capstone.model.ModelMovie();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.Shelly.Capstone.model.ModelMovie) cachedObject.object;
            }
            unmanagedObject = (com.Shelly.Capstone.model.ModelMovie) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_Shelly_Capstone_model_ModelMovieRealmProxyInterface unmanagedCopy = (com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) unmanagedObject;
        com_Shelly_Capstone_model_ModelMovieRealmProxyInterface realmSource = (com_Shelly_Capstone_model_ModelMovieRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_Shelly_Capstone_model_ModelMovieRealmProxy aModelMovie = (com_Shelly_Capstone_model_ModelMovieRealmProxy)o;
